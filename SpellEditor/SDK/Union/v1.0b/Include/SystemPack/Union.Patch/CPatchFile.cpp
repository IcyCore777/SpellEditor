...
{
	CPatchFile::CPatchFile (const Common::CString& fileName)
	{
	...
	CPatchFile* CPatchFile::LoadFile (const Common::CString& fileName)
	{
	...
	void CPatchFile::CloseFile()
	{
		...
		Common::CArray<CPatchType*>& arrVariables = CPatchType::arrVariables;
...
namespace SystemPack
{
	Common::CArray<CPatch*> CPatch::arrPatches;

	CPatch::CPatch(const Common::CString& name)
	{
		sName = name;
