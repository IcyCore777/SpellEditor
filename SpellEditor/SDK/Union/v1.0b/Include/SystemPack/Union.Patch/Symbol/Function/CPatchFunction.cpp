...
namespace SystemPack
{
	...
	void CPatchFunction::CreateParameters(const Common::CString& line)
	{
		...
		{
			Common::CString sWord = sNormal.GetSymbolEx( arrResource, ulResourceNum, arrBrackets, 4, 1, &ulLastIndex );
