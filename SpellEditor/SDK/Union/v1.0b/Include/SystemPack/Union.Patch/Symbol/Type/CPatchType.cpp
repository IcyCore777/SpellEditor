...
namespace SystemPack
{
	Common::CArray<CPatchType*> CPatchType::arrVariables;

	CPatchType* CPatchType::GetVariable(const Common::CString name)
	{
	...
	void CPatchType::SetObjectName(const Common::CString& objName)
	{
	...
	void CPatchType::SetOption(const Common::CString& objName)
	{
		sOptionName = objName;
	}

	Common::CString	CPatchType::GetObjectName()
	{
		return sObjectName;
	}

	Common::CString	CPatchType::GetOption()
	{
		return sOptionName;
	}

	void CPatchType::ReadOptionString (Common::CString& result, const Common::CString& optionName, const Common::CString& section, const Common::CString& value)
	{
	...
	void CPatchType::WriteOptionString (const Common::CString& data, const Common::CString& optionName, const Common::CString& section, const Common::CString& value)
	{
		if( !optionName.IsEmpty() )
		{
			if (optionName == "UNION")
