...
namespace SystemPack
{
	...
	CPatchStack* CPatchStack::CreateStack(const Common::CString& line)
	{
		...
		for (uint32 i = 1;; i++)
		{
			Common::CString sWord = line.GetSymbolEx( arrResource, ulResourceNum, arrBrackets, 4, 1, &ulLastIndex );
			...
			if( pFunc )
			{
				Common::CString sArguments = line.GetSymbolEx( arrResource, ulResourceNum, arrBrackets, 4, 1, &ulLastIndex );
