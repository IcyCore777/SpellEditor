...
namespace Gothic_II_Addon {
  ...
  public:
	...
	zBOOL __fastcall spcRenderStatic(zTRenderContext&		renderContext,
		int						renderFlags,
		zTLODRenderArgs			*lodRenderArgs,
		zCRenderLightContainer	*renderLightCont);
	int __fastcall spcRenderProgMesh(zTRenderContext&, int, zTLODRenderArgs*, zCRenderLightContainer*, float, float);
  };
