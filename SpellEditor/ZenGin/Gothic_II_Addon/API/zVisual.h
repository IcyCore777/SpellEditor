...
namespace Gothic_II_Addon {
  ...
  public:
	...
	const   zSTRING&		GetVobName() const								   { return objectName; };
    // static properties
  ...
  public:
    zCLASS_DECLARATION( zCDecal )
		void			GetDecalDim(float& xd, float& yd) const { xd = xdim; yd = ydim; };
  ...
  public:
    ...
    static zCMesh* Load( zSTRING const&, const zBOOL a_bDontConvertToNPolys = FALSE)                                               zCall( 0x00567600 );
