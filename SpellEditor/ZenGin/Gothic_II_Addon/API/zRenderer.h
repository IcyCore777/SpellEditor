...
namespace Gothic_II_Addon {
	...
	public:
		...
		virtual void Vid_Blit(zBOOL forceFlip = TRUE, RECT *sourceRect = NULL, RECT *destRect = NULL)                                                   zPureCall;
		virtual void Vid_Clear(zCOLOR&, int clearTarget = (zRND_CLEAR_FRAMEBUFFER | zRND_CLEAR_ZBUFFER))                                                             zPureCall;
