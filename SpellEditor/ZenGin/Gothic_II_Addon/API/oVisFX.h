...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    virtual void Init(const zCVob *orgVob = 0, const zCVob *trgtVob = 0, const zCVob* inflictorVob = 0)  zCall( 0x00491F20 );
    ...
    virtual void CalcTrajectory(const zBOOL &updateTargetOnly = FALSE)                                                            zCall( 0x0048F620 );
	...
	static void			    spcCreateNewScriptFX(const zSTRING &name);
	void Collide_union(const zBOOL killAfterDone);
    // static properties
