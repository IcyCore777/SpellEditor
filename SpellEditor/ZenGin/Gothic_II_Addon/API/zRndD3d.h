...
namespace Gothic_II_Addon {
	...
	public:
		...
		static void*& xd3d_pd3d7; // IDirect3D7
		static void*& xd3d_pd3dDevice7; //IDirect3DDevice7
		static unsigned long& xd3d_actFrameNumber;
		static int& xd3d_dd7inuse;
		static int& xd3d_palsupp;
		int spcSetAlphaBlendFuncImmed(zTRnd_AlphaBlendFunc);
		// user API
	...
	public:
		...
		void* xvb_vertexBuffer; //IDirect3DVertexBuffer7
