...
namespace Gothic_II_Addon {
  ...
  public:
	...
	zBOOL SetAndStartEmitter(const zSTRING& emitterName, const zBOOL createCopy = FALSE) zCall(0x005AED40);
	zBOOL SetAndStartEmitter(zCParticleEmitter* em, const zBOOL createCopy = FALSE) zCall(0x005AED70);
	...
	static void ParseParticleFXScript_union();
  };
