...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    void Line3D( zVEC3 const&, zVEC3 const&, zCOLOR, int useBuf = 0 ) zCall( 0x0050B450 );
  ...
  public:
	...
	zVEC3			Transform(const zVEC3& point) const { return camMatrix * point; };
	zCVob*				GetVob() const { return connectedVob; };
	void				SetVob(zCVob *vob) { connectedVob = vob; };
	void spcUpdateProjectionMatrix();
    // static properties
...
#pragma pack( pop )
    ...
    void TexApplyPlanarMapping( zVEC3 const&, zVEC3 const&, zVEC3 const&, zBOOL scaleByTexture = TRUE)                                       zCall( 0x005BAA20 );
    void TexApplyPlanarMapping(const float scaleu, const float scalev, zBOOL scaleByTexture = TRUE)                                                                   zCall( 0x005BABD0 );
    ...
    static void TexApplyPlanarMapping( zCList<zCPolygon> const&, float, float, zBOOL scaleByTexture = TRUE)                                  zCall( 0x005BAC90 );
