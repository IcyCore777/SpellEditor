...
namespace Gothic_II_Addon {
  ...
  public:
	...
	virtual zCArchiver*		CreateArchiverWrite(zTArchiveMode arcMode, zBOOL saveGame = FALSE, int arcFlags = 0)zCall(0x0051AF00);	// convenience, transient buffer created within archiver, for access must be readOut before archive is closed
  ...
  public:
    ...
    virtual zCObject* __fastcall ReadObject(zCObject* objectUseThis = 0)                                               zPureCall;
    virtual zCObject* __fastcall ReadObject(const char* chunkName, zCObject* objectUseThis = 0)                                  zPureCall;
