...
namespace Gothic_II_Addon {
  ...
  public:
	...
	float					GetAngleRollDeg() const { return angleRollDeg; };
	void					SetAngleRollDeg(const float w) { angleRollDeg = w; };
	float					GetCamFOVScale() const { return camFOVScale; };
	void					SetCamFOVScale(const float s) { camFOVScale = s; };
	...
	float					GetContinuity() const { return continuity; };
  ...
  public:
	...
	zVEC3			GetActFocusPos() const { return actTargetFocus; };
