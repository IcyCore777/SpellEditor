...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    virtual void EndMovement(const zBOOL a_bHintTrafoChanged = TRUE)                                                                    zCall( 0x0063C1A0 );
  ...
  public:
    ...
    void StartSound(zBOOL forceCacheIn = FALSE)                                                                             zCall( 0x0063E040 );
    ...
    virtual void EndMovement(const zBOOL a_bHintTrafoChanged = TRUE)                                                                    zCall( 0x0063D9D0 );
