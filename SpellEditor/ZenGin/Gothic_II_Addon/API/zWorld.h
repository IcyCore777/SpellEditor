...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    int __fastcall PickScene(zCCamera& cam, int xscr, int yscr, zREAL rayLength = -1)                                                         zCall( 0x00622710 );
    ...
    void TraverseVobTree(zCVobCallback &callback, void *callbackData = 0, zCTree<zCVob>* vobNode = 0)                                                  zCall( 0x00627F10 );
    ...
    virtual int LoadWorld(const zSTRING& fileName, const zTWorldLoadMode loadMode)                                 zCall( 0x006270D0 );
    virtual int SaveWorld( zSTRING const&, zTWorldSaveMode, int, int )                                             zCall( 0x00627BB0 );
    virtual zCVob* MergeVobSubtree(const zSTRING& fileName, zCVob* paramVob = 0, zTWorldLoadMergeMode mergeMode = zWLD_LOAD_MERGE_ADD)                                 zCall( 0x006273E0 );
    virtual int SaveVobSubtree(const zSTRING& fileName, zCVob* paramVob = 0, zTWorldLoadMergeMode mergeMode = zWLD_LOAD_MERGE_ADD)                                                 zCall( 0x00627E50 );
    ...
    virtual zCVob* SearchVob( zCVob*, zCTree<zCVob>* vobNode = 0)                                                             zCall( 0x00623F10 );
    virtual zCVob* SearchVobByID( unsigned long, zCTree<zCVob>* vobNode = 0)                                                  zCall( 0x00623F60 );
    ...
    virtual void SearchVobListByClass( zCClassDef*, zCArray<zCVob*>&, zCTree<zCVob>* vobNode = 0)                             zCall( 0x00624250 );
    virtual void SearchVobListByBaseClass( zCClassDef*, zCArray<zCVob*>&, zCTree<zCVob>* vobNode = 0)                         zCall( 0x00624320 );
	...
	void VobRemovedFromWorld_Hook(zCVob* pVob);
	int spcTraverseBspAddVobsToMesh(zCCBspTree*, zCTree<zCVob>*);
  };
