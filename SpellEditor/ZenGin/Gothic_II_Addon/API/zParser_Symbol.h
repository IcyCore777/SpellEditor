...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    void* GetDataAdr(int nr = 0)                zCall( 0x007A1A40 );
    ...
    void GetStackPos( int&, int nr = 0)               zCall( 0x007A1E10 );
    void SetStackPos( int, int )                zCall( 0x007A1E20 );
    void SetValue( int, int nr = 0)                   zCall( 0x007A1E30 );
    void SetValue( float, int nr = 0)                 zCall( 0x007A1E60 );
    void SetValue( zSTRING&, int nr = 0)              zCall( 0x007A1E90 );
    void GetValue( int&, int nr = 0)                  zCall( 0x007A1FE0 );
    void GetValue( float&, int nr = 0)                zCall( 0x007A2010 );
    void GetValue( zSTRING&, int nr = 0)              zCall( 0x007A2040 );
