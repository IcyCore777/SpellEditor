...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    void Error( zSTRING&, int nLine = -1)                                                     zCall( 0x0078E270 );
	...
	int SaveDScript(zSTRING file, zSTRING& sym, void* ptr);
    ...
    void SetInfoFile(zCList <zSTRING>* funclist, const zSTRING& infoFileName = "")  zCall( 0x00796200 );
    ...
    zCPar_TreeNode* Parse_Expression(int &token, int lp = -1)                       zCall( 0x0079A940 );
    ...
    void DeclareFuncCall( zSTRING&, int typematch = 0)                              zCall( 0x0079E7B0 );
    ...
    void __cdecl DefineExternal(const zSTRING &s, zBOOL(*Proc)(), int type, int param...) zCall( 0x007A0190 );
    ...
    // Spacer
    void  spcCreatePCode();
	void  spcDeclareAssign(zSTRING&s);
	void  spcDeclareInstance();
	void* __cdecl spcCallFunc(int, ...);
	void  spcError(zSTRING &e, int line);
	zBOOL spcWriteAdditionalInfo(zSTRING&, int, int);
  };
