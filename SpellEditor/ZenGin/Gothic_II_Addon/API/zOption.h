...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    int WriteInt( zSTRING const&, char const*, int, zBOOL temp = FALSE)                       zCall( 0x00461E30 );
    ...
    int WriteString(const zSTRING&, const char* , zSTRING	value, zBOOL temp = FALSE)        zCall( 0x00461FD0 );
    ...
    zSTRING ReadString(const zSTRING& secName, const char* name, const char* defaultVal = 0)  zCall( 0x004627E0 );
    ...
    int WriteInt( zSTRING const&, zSTRING const&, int, zBOOL temp = FALSE)                    zCall( 0x004638C0 );
