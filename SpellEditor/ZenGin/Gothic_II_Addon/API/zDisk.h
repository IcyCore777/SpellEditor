...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    virtual int Open(bool writeMode = false)                                      zPureCall;
    virtual int Open( zSTRING const&, bool writeMode = false)                      zPureCall;
  ...
  public:
    ...
    virtual int ChangeDir(bool physical = false)                  zCall( 0x00446670 );
    ...
    virtual int Open(bool writeMode = false)                                      zCall( 0x00443C90 );
    virtual int Open( zSTRING const&, bool writeMode = false)                      zCall( 0x00443360 );
