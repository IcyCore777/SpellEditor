...
// SpellEditor.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSpellApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSpellApp::OnAppAbout)
END_MESSAGE_MAP()
...
CSpellApp::CSpellApp()
{
	...
	SetAppID(_T("SpellEditor.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSpellApp

CSpellApp theApp;


// инициализация CSpellApp
...
BOOL CSpellApp::InitInstance()
{
	...
	if (!ProcessShellCommand(cmdInfo))
		return FALSE;
	if (dynamic_cast<CMainFrame*>(theApp.m_pMainWnd))
		static_cast<CMainFrame*>(theApp.m_pMainWnd)->InitWindows();
...
// обработчики сообщений CSpellApp
